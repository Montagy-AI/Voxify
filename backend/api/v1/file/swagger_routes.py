...
success_response = file_ns.model(
    "SuccessResponse",
    {
    ...
    def get(self):
        ...
        return success_response_data(
            data={
                ...
                "usage": {"total_files": 0, "total_size_bytes": 0, "user_files": 0, "user_size_bytes": 0},
    ...
    def post(self):
        ...
        return success_response_data(
            data={
                ...
                "categories": {"orphaned_files": 0, "temporary_files": 0, "expired_cache": 0},
            },
