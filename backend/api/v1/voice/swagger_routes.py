...
# Create namespace
voice_ns = Namespace('Voice Management', description='Voice sample upload, processing, and clone management', path='/voice')
...
# Define data models
voice_sample_model = voice_ns.model('VoiceSample', {
...
voice_clone_model = voice_ns.model('VoiceClone', {
    ...
    'quality_metrics': fields.Nested(voice_ns.model('QualityMetrics', {
...
clone_creation_request = voice_ns.model('CloneCreationRequest', {
...
synthesis_request = voice_ns.model('SynthesisRequest', {
...
pagination_model = voice_ns.model('Pagination', {
...
class VoiceClonesResource(Resource):
    ...
    def post(self):
        ...
        return success_response_data(
            data={"message": "Voice clone creation endpoint - implement with existing logic"},
            status_code=201
        )
    ...
    def get(self):
        ...
        return success_response_data(
            data={"message": "Voice clones list endpoint - implement with existing logic"}
        )
                ...
                "models": [
                    {
                        ...
                        "languages": [
                            ...
                            "ja-JP", "fr-FR", "de-DE", "es-ES", "it-IT", "ru-RU", "hi-IN", "fi-FI",  # Specialized
