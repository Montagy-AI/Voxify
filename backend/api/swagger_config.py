...
def configure_swagger(api):
    ...
    api.doc = {
        ...
        'tags': [
            ...
            {
                'name': 'Voice Samples',
                'description': 'Voice sample upload and management'
            },
            {
                'name': 'Voice Clones',
                'description': 'Voice clone creation and management'
            },
            {
                'name': 'Jobs',
                'description': 'Synthesis job management and monitoring'
            },
            {
                'name': 'Files',
                'description': 'File download and management'
            }
        ],
        'security': [
            {
...
def get_common_models(api):
    ...
    success_wrapper = api.model('SuccessResponse', {
...
def get_auth_models(api):
    ...
    reset_password_request = api.model('ResetPasswordRequest', {
...
def get_voice_models(api):
    ...
    # Voice sample model
    voice_sample_model = api.model('VoiceSample', {
    ...
    voice_clone_model = api.model('VoiceClone', {
        ...
        'quality_metrics': fields.Nested(api.model('QualityMetrics', {
    ...
    clone_creation_request = api.model('CloneCreationRequest', {
    ...
    synthesis_request = api.model('SynthesisRequest', {
...
def get_job_models(api):
    ...
    # Synthesis job model
    synthesis_job_model = api.model('SynthesisJob', {
    ...
    job_creation_request = api.model('JobCreationRequest', {
        'text_content': fields.String(required=True, description='Text to synthesize'),
    ...
    # Job update request
    job_update_request = api.model('JobUpdateRequest', {
    ...
    job_status_update = api.model('JobStatusUpdate', {
