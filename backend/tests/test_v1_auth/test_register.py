...
class TestRegister(unittest.TestCase):
    ...
    def test_register_weak_password(self):
        ...
        response = self.client.post(
            "/api/v1/auth/register", json={"email": "user@example.com", "password": "weak"}  # Very weak password
        )
        self.assertEqual(response.status_code, 400)
        data = response.get_json()
        # Update this assertion based on what your API actually returns
    ...
    def test_register_email_already_exists(self):
        ...
        self.client.post(
            "/api/v1/auth/register", json={"email": "duplicate@example.com", "password": "SecurePassword123!"}
        )
    ...
    def test_register_internal_error(self):
        ...
        response = self.client.post(
            "/api/v1/auth/register", json={"email": "user@example.com", "password": "SecurePassword123!"}
        )
