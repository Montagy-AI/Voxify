...
class TestVoiceSampleValidation:
    ...
    def test_allowed_file_valid_extensions(self):
        ...
        valid_files = ["sample.wav", "voice.mp3", "test.WAV", "audio.MP3", "file.wav", "recording.mp3"]
    ...
    def test_extract_audio_metadata_success(self, mock_soundfile):
        ...
        expected_metadata = {"duration": 1.0, "sample_rate": 22050, "channels": 1, "format": "WAV"}
...
class TestVoiceCloneValidation:
    ...
    def test_clone_data_missing_required_fields(self):
        ...
        test_cases = [
            ...
            {"data": {"sample_ids": ["sample1"], "ref_text": "Text"}, "missing": "name"},
            {"data": {"sample_ids": ["sample1"], "name": "Test"}, "missing": "ref_text"},
        ]
...
class TestVoiceResponseFormatters:
    ...
    def test_success_response_basic(self):
        ...
        with patch("api.v1.voice.samples.jsonify") as mock_jsonify:
            ...
            response = mock_jsonify({"success": True, "data": {"sample_id": "test_id", "name": "Test Sample"}})
