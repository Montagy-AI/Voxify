...
from api.v1.job.routes import validate_synthesis_job_data, generate_text_hash, error_response, success_response
...
class TestJobValidation:
    ...
    def test_validate_synthesis_job_data_invalid_speed(self):
        ...
        for case in test_cases:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "speed": case["speed"]}
    ...
    def test_validate_synthesis_job_data_invalid_pitch(self):
        ...
        for case in test_cases:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "pitch": case["pitch"]}
    ...
    def test_validate_synthesis_job_data_invalid_volume(self):
        ...
        for case in test_cases:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "volume": case["volume"]}
    ...
    def test_validate_synthesis_job_data_invalid_output_format(self):
        ...
        data = {"text_content": "Hello world", "voice_model_id": "vm_123", "output_format": "invalid_format"}
    ...
    def test_validate_synthesis_job_data_valid_output_formats(self):
        ...
        for format_type in valid_formats:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "output_format": format_type}
    ...
    def test_validate_synthesis_job_data_invalid_sample_rate(self):
        ...
        for case in test_cases:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "sample_rate": case["sample_rate"]}
    ...
    def test_validate_synthesis_job_data_valid_sample_rates(self):
        ...
        for rate in valid_rates:
            data = {"text_content": "Hello world", "voice_model_id": "vm_123", "sample_rate": rate}
