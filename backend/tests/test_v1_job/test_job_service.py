...
class TestJobServiceAPI:
    ...
    def test_user(self):
        ...
        return {"email": "jobtest@example.com", "password": "Test123!@#", "first_name": "Job", "last_name": "Tester"}
    ...
    def test_update_job_valid_data(self, server_url, auth_tokens, test_voice_model_id):
        ...
        # First create a job
        job_data = {"text_content": "Original text", "voice_model_id": test_voice_model_id, "output_format": "wav"}
        ...
        # Update the job
        update_data = {"text_content": "Updated text content", "speed": 1.5, "pitch": 1.2, "volume": 0.8}
    ...
    def test_patch_job_status(self, server_url, auth_tokens, test_voice_model_id):
        ...
        patch_data = {"status": "processing", "progress": 0.5, "processing_time_ms": 1000}
    ...
    def test_unauthorized_access(self, server_url):
        ...
        for method, endpoint in endpoints:
            curl_cmd = ["curl", "-X", method, f"{server_url}{endpoint}", "-H", "Content-Type: application/json"]
