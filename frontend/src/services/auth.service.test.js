    ...
    */
	describe('getUserProfile', () => {
		...
		test('Throw error when response format is invalid - no success', async () => {
			...
			await expect(authService.getUserProfile()).rejects.toThrow('Invalid response format');
		});
		...
		test('Network error throws the error', async () => {
			...
			await expect(authService.getUserProfile()).rejects.toThrow('Network Error');
		});
	});
    ...
    */
	describe('updateUserProfile', () => {
		...
		test('Throw error when response format is invalid - no success', async () => {
			...
			await expect(authService.updateUserProfile(mockUserData)).rejects.toThrow('Invalid response format');
		});
		...
		test('Network error throws the error', async () => {
			...
			await expect(authService.updateUserProfile(mockUserData)).rejects.toThrow('Network Error');
		});
	});
});
