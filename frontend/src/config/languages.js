...
export const LANGUAGE_GROUPS = {
    ...
    "专用模型支持 (高质量)": ["ja-JP", "fr-FR", "de-DE", "es-ES", "it-IT", "ru-RU", "hi-IN"],
...
export const getLanguageOptions = (includeGroups = false, showSupportLevel = true) => {
    if (!includeGroups) {
...
export const SAMPLE_TEXTS = {
    "en-US": "Hello, this is a test of English speech synthesis. The weather is beautiful today.",
    "en-GB": "Good day! This is a demonstration of British English voice synthesis technology.",
    "zh-CN": "你好，这是中文语音合成的测试。今天天气很好。",
    "zh-TW": "您好，這是繁體中文語音合成的測試。今天天氣很好。",
    "ja-JP": "こんにちは。これは日本語の音声合成テストです。今日はとても良い天気ですね。",
    "ko-KR": "안녕하세요. 이것은 한국어 음성 합성 테스트입니다. 오늘 날씨가 정말 좋네요.",
    "fr-FR": "Bonjour, ceci est un test de synthèse vocale française. Il fait très beau aujourd'hui.",
    "de-DE": "Hallo, das ist ein Test der deutschen Sprachsynthese. Das Wetter ist heute wunderschön.",
    "es-ES": "Hola, esta es una prueba de síntesis de voz en español. Hace muy buen tiempo hoy.",
    "it-IT": "Ciao, questo è un test di sintesi vocale italiana. Oggi c'è un tempo bellissimo.",
    "pt-BR": "Olá, este é um teste de síntese de voz em português brasileiro. O tempo está lindo hoje.",
    ...
    "hi-IN": "नमस्ते, यह हिंदी भाषा संश्लेषण का परीक्षण है। आज मौसम बहुत अच्छा है।",
